...
export const EXERCISE_INFO: Record<string, ExerciseInfo> = {
  ...
  incline_bar:  { setup: "Bench at 30–45°, grip slightly wider than shoulders.",                      execute: "Lower bar to upper chest, press straight up.",                             cue: "Tuck elbows on the descent, it protects the shoulders." },
  ...
  assisted_dips:{ setup: "Assisted-dip machine, knees on the pad, hands on parallel bars.",           execute: "Lower under control until shoulders pass elbows, then press up.",           cue: "Less assist over time — the goal is unassisted dips." },
  ...
  arnold:       { setup: "Seated, DBs in front of shoulders, palms facing you.",                      execute: "Press up while rotating, finishing with palms forward overhead.",          cue: "Smooth continuous rotation, no jerking." },
  ...
  assisted_pullups: { setup: "Assisted-pull machine, knees on the pad, overhand grip on the bar.",    execute: "Pull chin over the bar, lower with control to full hang.",                  cue: "Drop the assist gradually — that's the progression." },
  assisted_chinups: { setup: "Assisted-pull machine, knees on the pad, supinated grip on the bar.",   execute: "Pull chin over the bar, biceps driving, lower with control.",               cue: "Squeeze the biceps at the top. Less assist each block." },
  ...
  upright_row:  { setup: "Bar at thighs, shoulder-width grip.",                                       execute: "Pull bar to upper chest, leading with the elbows.",                        cue: "Stop if shoulders click and switch to a high-pull." },
  ...
  leg_press:    { setup: "Feet shoulder-width on plate, mid-foot.",                                   execute: "Lower until knees ~90°, press through full foot.",                         cue: "Don't lock out fully, protect those knees." },
  ...
  sdl:          { setup: "Like an RDL but stricter knee lock.",                                       execute: "Hinge with straighter legs, deep ham stretch.",                            cue: "Back stays flat. Protect the lumbar." },
  ...
  hanging_lr:   { setup: "Hang from a bar, brace your core.",                                         execute: "Raise legs to parallel or higher, lower with control.",                    cue: "No swinging. Strict form only." },
  dragon:       { setup: "Lying on bench, body straight, gripping behind head.",                      execute: "Lower with full control, raise back to start.",                            cue: "Advanced movement. Strict form only." },
  ...
  wrist_curl:   { setup: "Forearms on bench, bar in hands, palms up.",                                execute: "Let bar roll to fingertips, curl back up using wrist.",                    cue: "Slow and controlled, small ROM." },
