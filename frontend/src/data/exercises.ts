...
export const EM: Record<string, { p: string[]; s: string[] }> = {
  ...
  assisted_dips: { p: ["lower_pec", "tricep_long"],                           s: ["front_delt", "tricep_lat"] },
  ...
  assisted_pullups: { p: ["upper_lat", "lower_lat"],                          s: ["teres_major", "bicep_long", "rear_delt"] },
  assisted_chinups: { p: ["upper_lat", "lower_lat", "bicep_short"],           s: ["bicep_long", "rear_delt", "teres_major"] },
  ...
  // ── Calisthenics: pressing / handstand / planche skills ─────────────────────
  pike_pushup:        { p: ["front_delt", "upper_pec"],                       s: ["tricep_lat", "tricep_med", "side_delt"] },
  wall_handstand:     { p: ["front_delt", "side_delt"],                       s: ["upper_trap", "tricep_lat", "upper_abs"] },
  handstand:          { p: ["front_delt", "side_delt"],                       s: ["upper_trap", "tricep_lat", "upper_abs", "forearm"] },
  wall_hspu:          { p: ["front_delt", "side_delt"],                       s: ["tricep_lat", "tricep_med", "upper_trap"] },
  hspu:               { p: ["front_delt", "side_delt"],                       s: ["tricep_lat", "tricep_med", "upper_trap", "upper_abs"] },
  pseudo_planche_pu:  { p: ["lower_pec", "front_delt"],                       s: ["tricep_lat", "upper_pec", "upper_abs"] },
  planche_lean:       { p: ["front_delt", "lower_pec"],                       s: ["bicep_long", "upper_abs", "forearm"] },
  tuck_planche:       { p: ["front_delt", "lower_pec"],                       s: ["bicep_long", "upper_abs", "forearm"] },
  adv_tuck_planche:   { p: ["front_delt", "lower_pec"],                       s: ["bicep_long", "upper_abs", "forearm"] },
  straddle_planche:   { p: ["front_delt", "lower_pec"],                       s: ["bicep_long", "upper_abs", "lower_abs", "forearm"] },
  full_planche:       { p: ["front_delt", "lower_pec"],                       s: ["bicep_long", "upper_abs", "lower_abs", "forearm"] },
  ring_dips:          { p: ["lower_pec", "tricep_long"],                      s: ["front_delt", "tricep_lat", "upper_abs"] },
  korean_dips:        { p: ["lower_pec", "front_delt"],                       s: ["tricep_long", "tricep_lat"] },

  // ── Calisthenics: pulling / lever skills ────────────────────────────────────
  ring_row:           { p: ["rhomboid", "lower_lat"],                         s: ["rear_delt", "bicep_long", "lower_trap"] },
  archer_pullup:      { p: ["upper_lat", "lower_lat"],                        s: ["bicep_long", "teres_major", "oblique"] },
  typewriter_pullup:  { p: ["upper_lat", "lower_lat"],                        s: ["bicep_long", "teres_major", "oblique"] },
  explosive_pullup:   { p: ["upper_lat", "lower_lat"],                        s: ["teres_major", "bicep_long", "rear_delt"] },
  muscle_up:          { p: ["upper_lat", "lower_pec", "tricep_long"],         s: ["bicep_long", "front_delt", "rhomboid"] },
  bar_muscle_up:      { p: ["upper_lat", "lower_pec", "tricep_long"],         s: ["bicep_long", "front_delt", "rhomboid"] },
  ring_muscle_up:     { p: ["upper_lat", "lower_pec", "tricep_long"],         s: ["bicep_long", "front_delt", "rhomboid", "forearm"] },
  skin_cat:           { p: ["upper_lat", "teres_major"],                      s: ["lower_pec", "rhomboid", "forearm"] },
  tuck_fl:            { p: ["lower_lat", "upper_lat"],                         s: ["rhomboid", "lower_trap", "lower_abs"] },
  adv_tuck_fl:        { p: ["lower_lat", "upper_lat"],                         s: ["rhomboid", "lower_trap", "lower_abs"] },
  straddle_fl:        { p: ["lower_lat", "upper_lat"],                         s: ["rhomboid", "lower_trap", "lower_abs", "upper_abs"] },
  front_lever:        { p: ["lower_lat", "upper_lat"],                         s: ["rhomboid", "lower_trap", "lower_abs", "upper_abs"] },
  fl_raise:           { p: ["lower_lat", "upper_lat"],                         s: ["lower_abs", "rhomboid", "teres_major"] },
  tuck_bl:            { p: ["upper_lat", "teres_major"],                       s: ["lower_pec", "rear_delt", "bicep_long"] },
  back_lever:         { p: ["upper_lat", "teres_major"],                       s: ["lower_pec", "rear_delt", "bicep_long", "erector"] },
  ice_cream_maker:    { p: ["upper_lat", "lower_lat"],                         s: ["bicep_long", "rhomboid", "lower_abs"] },

  // ── Calisthenics: core / lower-body skills ──────────────────────────────────
  tuck_l_sit:         { p: ["lower_abs", "upper_abs"],                        s: ["oblique", "quad_rf"] },
  v_sit:              { p: ["lower_abs", "upper_abs"],                        s: ["quad_rf", "oblique"] },
  human_flag:         { p: ["oblique", "lower_lat"],                          s: ["side_delt", "upper_abs", "teres_major"] },
  tuck_human_flag:    { p: ["oblique", "lower_lat"],                          s: ["side_delt", "upper_abs", "teres_major"] },
  pistol_squat:       { p: ["quad_rf", "glute_max"],                          s: ["quad_vl", "quad_vmo", "ham_bf", "adductor"] },
  box_pistol:         { p: ["quad_rf", "glute_max"],                          s: ["quad_vl", "quad_vmo", "ham_bf"] },
  assisted_pistol:    { p: ["quad_rf", "glute_max"],                          s: ["quad_vl", "quad_vmo", "ham_bf"] },
  shrimp_squat:       { p: ["quad_rf", "glute_max"],                          s: ["quad_vmo", "ham_bf", "quad_vl"] },
};
...
export const EX: Record<string, ExerciseDef[]> = {
  Push: [
    ...
    { id: "assisted_dips",  name: "Assisted Dips",          type: "strength", is_assisted: true },
  ...
  Pull: [
    ...
    { id: "assisted_pullups", name: "Assisted Pull-ups",    type: "strength", is_assisted: true },
    { id: "chinups",        name: "Chin-ups",               type: "strength" },
    { id: "assisted_chinups", name: "Assisted Chin-ups",    type: "strength", is_assisted: true },
  ...
  Calisthenics: [
    // Pressing / handstand / planche
    { id: "pike_pushup",       name: "Pike Push-up",            type: "strength" },
    { id: "wall_hspu",         name: "Wall Handstand Push-up",  type: "strength" },
    { id: "hspu",              name: "Handstand Push-up",       type: "strength" },
    { id: "pseudo_planche_pu", name: "Pseudo-Planche Push-up",  type: "strength" },
    { id: "ring_dips",         name: "Ring Dips",               type: "strength" },
    { id: "korean_dips",       name: "Korean Dips",             type: "strength" },
    { id: "wall_handstand",    name: "Wall Handstand Hold",     type: "timed"    },
    { id: "handstand",         name: "Freestanding Handstand",  type: "timed"    },
    { id: "planche_lean",      name: "Planche Lean",            type: "timed"    },
    { id: "tuck_planche",      name: "Tuck Planche",            type: "timed"    },
    { id: "adv_tuck_planche",  name: "Adv. Tuck Planche",       type: "timed"    },
    { id: "straddle_planche",  name: "Straddle Planche",        type: "timed"    },
    { id: "full_planche",      name: "Full Planche",            type: "timed"    },
    // Pulling / levers
    { id: "ring_row",          name: "Ring Row",                type: "strength" },
    { id: "archer_pullup",     name: "Archer Pull-up",          type: "strength" },
    { id: "typewriter_pullup", name: "Typewriter Pull-up",      type: "strength" },
    { id: "explosive_pullup",  name: "Explosive Pull-up",       type: "strength" },
    { id: "muscle_up",         name: "Muscle-up",               type: "strength" },
    { id: "bar_muscle_up",     name: "Bar Muscle-up",           type: "strength" },
    { id: "ring_muscle_up",    name: "Ring Muscle-up",          type: "strength" },
    { id: "fl_raise",          name: "Front Lever Raise",       type: "strength" },
    { id: "ice_cream_maker",   name: "Ice Cream Maker",         type: "strength" },
    { id: "skin_cat",          name: "Skin the Cat",            type: "strength" },
    { id: "tuck_fl",           name: "Tuck Front Lever",        type: "timed"    },
    { id: "adv_tuck_fl",       name: "Adv. Tuck Front Lever",   type: "timed"    },
    { id: "straddle_fl",       name: "Straddle Front Lever",    type: "timed"    },
    { id: "front_lever",       name: "Front Lever",             type: "timed"    },
    { id: "tuck_bl",           name: "Tuck Back Lever",         type: "timed"    },
    { id: "back_lever",        name: "Back Lever",              type: "timed"    },
    // Core / lower-body skills
    { id: "tuck_l_sit",        name: "Tuck L-Sit",              type: "timed"    },
    { id: "v_sit",             name: "V-Sit",                   type: "timed"    },
    { id: "tuck_human_flag",   name: "Tuck Human Flag",         type: "timed"    },
    { id: "human_flag",        name: "Human Flag",              type: "timed"    },
    { id: "pistol_squat",      name: "Pistol Squat",            type: "strength" },
    { id: "box_pistol",        name: "Box Pistol Squat",        type: "strength" },
    { id: "assisted_pistol",   name: "Assisted Pistol Squat",   type: "strength", is_assisted: true },
    { id: "shrimp_squat",      name: "Shrimp Squat",            type: "strength" },
  ],
  Grip: [
