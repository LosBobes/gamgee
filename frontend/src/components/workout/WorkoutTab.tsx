...
export default function WorkoutTab({
  ...
  weeklyPlan, setWeeklyPlan, progressionSpeed, onProgressionSpeedChange, restPrefs, rpeMultipliers, rpePerExercise, rpeEnabled, wizardTransition, authFetch, onLoadToday,
